    ...
    <div className={className}>
        ...
        finalRequests.map((finalRequest) => (
          <Card key={finalRequest.finalRequestId} className="mb-4">
            ...
            <div className="flex justify-around mt-2">
              <Button
                className="bg-ocher1 hover:bg-ocher2"
                onClick={(e) =>
              ...
              <Button
                className="bg-green2 hover:bg-green2hover"
                type="button"
      ...
      {showFileUploadOverlay && (
        <div className="fixed inset-0 flex items-center justify-center bg-dark bg-opacity-50">
          <div className="bg-green3 p-8 rounded-full shadow-md w-96">
            <input
              type="file"
              accept=".pdf"
            ...
            <div className="flex justify-between">
              <Button
                className="bg-green1 hover:bg-green1hover text-white px-4 py-2 rounded-full"
                type="button"
              ...
              <Button
                className="bg-ocher1 hover:bg-ocher2 px-4 py-2 rounded-full"
                type="button"
