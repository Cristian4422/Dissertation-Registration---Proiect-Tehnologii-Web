...
const RequestGenerator = ({ student, professor }) => {
  ...
  return (
    <div className="flex flex-col items-center bg-green4 shadow-md rounded-lg p-8">
      ...
      <div className="mt-7">
        <PDFDownloadLink
          ...
          className="inline-block bg-ocher1 hover:bg-ocher2 text-white font-bold py-2 px-4 rounded-full"
        >
          {({ loading }) =>
